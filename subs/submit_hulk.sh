...
export INPUT_DIR="/xdisk/bhurwitz/mattmiller899/alise_project/results/filter_reads"
export FILE_LIST="./filelists/${JOB}.txt"
find $INPUT_DIR -name *filtered.fq > $FILE_LIST
#echo "/xdisk/bhurwitz/mattmiller899/alise_project/test/vsearch_filtered.fq" > $FILE_LIST
